...
def clip_imageencoder(name):
    model, _preprocess = clip.load(name, device="cpu", jit=False)
...
def get_backbone(name, preserve_readout, pretrained):
    if not pretrained:
        assert name in ["resnet50", "resnet50_custom", "resnet50_places", "swag_regnety_16gf"], "Only RN50/RegNet supports non-pretrained network"
    ...
    if name == "resnet18":
        ...
        n_outputs = 2048
    elif name == "resnet50_moco" or name == "resnet50_custom" or name == "resnet50_places" or name == "resnet50_cityscapes":
        ...
        if name == "resnet50_moco":
            ckpt_path = "./r-50-1000ep.pth.tar"
        elif name == "resnet50_custom":
            ckpt_path = "/scratch/yluo97/imagenet1k_80k/resnet50_imagenet1k_80k_batch128_49.pth"
        elif name == "resnet50_places":
            ckpt_path = "./resnet50_places365.pt"
        elif name == "resnet50_cityscapes":
            ckpt_path = "./deeplabv3_cityscapes_resnet50-19c8e357.pth"
        ...
        if name == "resnet50_places" or name == "resnet50_cityscapes":
